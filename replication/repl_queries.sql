...
-- to get the publisher database details
SELECT id, 
publisher_id, 
publisher_db, 
...
-- to get the subscriber schedule details
...
--get details about all the agent profiles
SELECT profile_id,
profile_name,
agent_type,
CASE agent_type 
...
-- to get details about snapshot agents
SELECT *, 
...
-- to get details about Log reader agents
SELECT *, 
CASE publisher_security_mode 
	WHEN 0 THEN 'Microsoft SQL Server Authentication'
	WHEN 1 THEN 'Microsoft Windows Authentication'
...
-- to get details about distribution agents
SELECT * ,
...
-- to get details about Merge agents
SELECT *, 
CASE publisher_security_mode 
	WHEN 0 THEN 'Microsoft SQL Server Authentication'
	WHEN 1 THEN 'Microsoft Windows Authentication'
...
-- to get details about Q-reader agents
...
-- to get details about subscribers
